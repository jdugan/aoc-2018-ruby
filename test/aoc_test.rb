...
class AocTest < ActiveSupport::TestCase
  ...
  test 'day05 runner yields correct answers' do
    puts ''
    assert_equal Day05::Runner.p1, 11252            # possible to improve reduction?
  ...
  test 'day20 runner yields correct answers' do
    puts ''
    assert_equal Day20::Runner.p1, 3476             #   ~15s
    assert_equal Day20::Runner.p2, 8514
  end
